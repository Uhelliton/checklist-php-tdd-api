...
class TaskTest extends TestCase
{
    ...
    /** @test ***/
    public function it_should_show_task()
    {
        $response = $this->withHeaders([
            'Authorization' => 'Bearer '. $this->token,
        ]);

        $response->get('api/tasks/1')->assertStatus(200);
    }

    /** @test ***/
    public function it_should_show_task_unauthorized()
    {
        $this->get('api/tasks/1')->assertUnauthorized(200);
    }
